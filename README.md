...
<head>
  ...
  <style>
    ...
    .hero p{ margin:15px auto 0; max-width:700px; font-size:17px; color:var(--muted); line-height:1.6; }

    .nav{ display:flex; flex-wrap:wrap; gap:12px; justify-content:center; margin-top:24px; }
    .nav a{
      text-decoration:none; color:var(--link); font-weight:600; font-size:15px;
      background:#fff; border:1px solid rgba(2,6,23,.08);
      padding:10px 16px; border-radius:999px; box-shadow:var(--shadow);
      transition: all .2s ease;
    }
    .nav a:hover{ color:var(--link-hover); transform:translateY(-2px); }
    ...
    .contact{ margin-top:12px; font-size:15px; line-height:1.6; }
